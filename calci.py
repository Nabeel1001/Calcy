...
def mic_semi():
    root.title("Calculator (Recognizing)")
    try:
...
conv_btn = Button(btnrow3, text="Mic", font="Segoe 12 bold", relief=GROOVE, bd=0, command=mic, fg="white", bg="#333333")
