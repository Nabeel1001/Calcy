...
icon = PhotoImage(file="calcy.png")
...
def mic_semi():
    try:
        ...
        disp.insert(0, myText)
        myText = float(print(myText))
        conv_btn.config(text="Mic")
...
def mic():
    conv_btn.config(text="Listening")
    root.after(90, mic_semi)
...
conv_btn = Button(btnrow3, text="Mic", font="Segoe 12 bold", relief=GROOVE, bd=0, command=mic, fg="skyblue", bg="#333333")
...
btnc = Button(btnrow4, text="C", font="Segoe 23", relief=GROOVE, bd=0, command=btnc_clicked, fg="red", bg="#333333")
